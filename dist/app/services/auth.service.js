...
const registerUser = (userData, profileData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const existing = yield user_repository_1.UserRepository.findByEmail(email);
    ...
    if (existing &&
        ...
        user_repository_1.UserRepository.deleteUser(existing.id);
    }
    ...
    try {
        const { user } = yield helper_repository_1.Repository.transaction((trx) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const profile = yield auth_repository_1.AuthRepository.createProfile(Object.assign(Object.assign({}, profileData), { user_id: user.id }), trx);
            const authentication = yield auth_repository_1.AuthRepository.createAuthentication({
                user_id: user.id,
                otp,
                expire_time,
...
const userLogin = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user_data = yield user_repository_1.UserRepository.findByEmail(data.email);
    if (!user_data) {
...
const forgotPassword = (user_email) => __awaiter(void 0, void 0, void 0, function* () {
    const user_data = yield user_repository_1.UserRepository.findByEmail(user_email);
    if (!user_data) {
        throw new AppError_1.AppError("Account not found.", 404);
    }
    const code = String((0, getOtp_1.default)(4));
